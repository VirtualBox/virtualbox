...
# define RTLocalIpcSessionVerifySameUser                RT_MANGLER(RTLocalIpcSessionVerifySameUser)
...
# define RTStrLenAndValidateEncoding                    RT_MANGLER(RTStrLenAndValidateEncoding)
...
# define RTUtf16LenAndValidateEncoding                  RT_MANGLER(RTUtf16LenAndValidateEncoding)
