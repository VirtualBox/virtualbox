...
FILE_HEADER = '''# Caution: auto-generated file. Don't edit.
...
def main():
    ...
    for enum_entry in data:
        enum_name = enum_entry.get('enum')
        vbox_values = enum_entry.get('values', [])

        context = {
            'enum_name': enum_name,
            'vbox_values': vbox_values,
        }

        code = code_template.render(**context)
