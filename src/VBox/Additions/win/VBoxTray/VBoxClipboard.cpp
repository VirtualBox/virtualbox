/* $Id: VBoxClipboard.cpp 115127 2026-08-25 13:40:12Z andreas.loeffler@oracle.com $ */
/** @file
...
static DECLCALLBACK(int)  vbtrShClTransferInitializedCallback(PSHCLTRANSFERCALLBACKCTX pCbCtx);
