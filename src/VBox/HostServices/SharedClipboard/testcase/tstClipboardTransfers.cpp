/* $Id: tstClipboardTransfers.cpp 114909 2026-08-10 08:46:37Z andreas.loeffler@oracle.com $ */
/** @file
...
static void testEvents(void)
{
    ...
    RTTESTI_CHECK_RC_OK(ShClPayloadAlloc(42, &uPayloadData, sizeof(uPayloadData), &pPayload));
    ...
    if (pPayloadResult)
    {
        ...
        ShClPayloadFree(pPayloadResult);
    }
