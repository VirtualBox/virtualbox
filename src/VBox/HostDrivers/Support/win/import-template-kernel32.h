SUPHARNT_IMPORT_STDCALL(AssignProcessToJobObject, 8)
SUPHARNT_IMPORT_STDCALL(CreateFileW, 28)
SUPHARNT_IMPORT_STDCALL(CreateJobObjectA, 8)
...
SUPHARNT_IMPORT_STDCALL(GetSystemTime, 4)
...
SUPHARNT_IMPORT_STDCALL(QueryInformationJobObject, 20)
SUPHARNT_IMPORT_STDCALL(SetInformationJobObject, 16)
