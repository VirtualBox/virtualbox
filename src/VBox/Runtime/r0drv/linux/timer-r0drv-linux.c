/* $Id: timer-r0drv-linux.c 114176 2026-05-22 11:34:30Z vadim.galitsyn@oracle.com $ */
/** @file
...
{
# if RTLNX_VER_MIN(6,16,0) || RTLNX_RHEL_RANGE(9,9, 9,99) || RTLNX_RHEL_RANGE(10,2, 10,99)
