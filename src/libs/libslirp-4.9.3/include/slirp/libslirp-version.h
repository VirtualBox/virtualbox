...
#define SLIRP_MICRO_VERSION     3                 /* UPGRADE: Must update version here! (Use/see git-version-gen.) */
#define SLIRP_VERSION_STRING    "4.9.3.0"         /* UPGRADE: Must update version here! (Use/see git-version-gen.) */
