...
/**
 * @brief Open a TCP/IP - VPN tunnel channel.
 *
 * @param[in]  channel  An allocated channel.
 *
 * @param[in]  remoteunit   The remote interface number, or may be 0x7fffffff
 *                          to allow the server to automatically choose
 *                          an interface.
 *
  * @return              SSH_OK on success,
 *                      SSH_ERROR if an error occurred,
 ...
 *                      to be done again.
 *
 * @warning This function does not bind the channel to a local interface
 ...
 * @warning Requires support of OpenSSH for VPN tunneling.
  */
int ssh_channel_open_tunnel(ssh_channel channel,
                            int remoteunit)
{
    ssh_session session = NULL;
    ssh_buffer payload = NULL;
