...
#endif
#define VBOX_PROXY_PREFIX "#VBoxProxy"
#define VBOX_PROXY_PREFIX_LENGTH (sizeof(VBOX_PROXY_PREFIX) - 1)
int ssh_socket_connect_proxycommand_vbox(ssh_socket s, const char *host,
                                      uint16_t port, const char *command);
